...
void EnfHG_Intro(EnfHG* this, PlayState* play) {
    ...
    switch (this->cutsceneState) {
        ...
        case INTRO_START:
            if (GET_EVENTCHKINF(EVENTCHKINF_72)) {
                ...
                if (this->timers[0] == 51) {
                    ...
                    Audio_QueueSeqCmd(SEQ_PLAYER_BGM_MAIN << 24 | 0x30);
                }
                if (this->timers[0] == 0) {
        ...
        case INTRO_BACK:
            ...
            if (this->timers[0] == 1) {
                Audio_QueueSeqCmd(SEQ_PLAYER_BGM_MAIN << 24 | /*NA_BGM_OPENING_GANON*/0x63);
            }
        ...
        case INTRO_LAUGH:
            ...
            if (this->timers[0] == 20) {
                Audio_QueueSeqCmd(SEQ_PLAYER_BGM_MAIN << 24 | /*NA_BGM_BOSS*/0x30);
            }
            if (this->timers[0] == 2) {
                this->subCamVelFactor = 0.0f;
        ...
        case INTRO_FINISH:
            ...
            if (this->timers[1] == 0) {
                ...
                func_800C08AC(play, this->subCamId, 0); //Play_ReturnToMainCam
                this->subCamId = SUB_CAM_ID_DONE;
                func_80064534(play, &play->csCtx); //Cutscene_StopManual
...
void EnfHG_Damage(EnfHG* this, PlayState* play) {
    ...
    if (dxz2 == 0.0f) {
        ...
        this->actionFunc = EnfHG_Retreat;
        Animation_MorphToLoop(&this->skin.skelAnime, &gPhantomHorseRunningAnim, 0.0f);
        // Check for boss health. By default 24
        if (bossGnd->actor.colChkInfo.health >= 46 ) {
                this->bossGndSignal = FHG_RIDE;
            } else {
...
void EnfHG_Retreat(EnfHG* this, PlayState* play) {
    ...
    if (this->actor.params == GND_REAL_BOSS) {
        ...
        // bossGnd->actor.flags |= ACTOR_FLAG_7;
        this->hoofSfxPos.x = this->actor.projectedPos.x / (this->actor.scale.x * 100.0f);
        this->hoofSfxPos.y = this->actor.projectedPos.y / (this->actor.scale.x * 100.0f);
        this->hoofSfxPos.z = this->actor.projectedPos.z / (this->actor.scale.x * 100.0f);
        if ((this->gallopTimer % 8) == 0) {
    ...
    if (this->timers[0] == 0) {
        ...
        s16 paintingIdxReal;
        s16 paintingIdxFake;
        s16 paintingIdxFake2;
        s16 paintingIdxFake3;
        ...
        if (this->actor.params != GND_REAL_BOSS) {
            ...
            do {
                paintingIdxFake2 = Rand_ZeroOne() * 5.99f;
            } while (paintingIdxFake2 == paintingIdxReal);
            osSyncPrintf("ac1 = %x `````````````````````````````````````````````````\n",
                         Actor_SpawnAsChild(&play->actorCtx, &this->actor, play, ACTOR_BOSS_GANONDROF,
                                            this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z,
                                            0, 0, 0, paintingIdxFake2 + GND_FAKE_BOSS));
            do {
                paintingIdxFake3 = Rand_ZeroOne() * 5.99f;
            } while (paintingIdxFake3 == paintingIdxReal);
            osSyncPrintf("ac1 = %x `````````````````````````````````````````````````\n",
                         Actor_SpawnAsChild(&play->actorCtx, &this->actor, play, ACTOR_BOSS_GANONDROF,
                                            this->actor.world.pos.x, this->actor.world.pos.y, this->actor.world.pos.z,
                                            0, 0, 0, paintingIdxFake3 + GND_FAKE_BOSS));
...
void EnfHG_Draw(Actor* thisx, PlayState* play) {
    ...
    if(this->actionFunc == EnfHG_Damage){
