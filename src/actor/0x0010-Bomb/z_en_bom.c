...
void EnBom_Explode(EnBom* this, PlayState* play) {
    ...
    this->explosionCollider.elements[0].dim.worldSphere.center.x = this->actor.world.pos.x;
    this->explosionCollider.elements[0].dim.worldSphere.center.y = this->actor.world.pos.y;
    this->explosionCollider.elements[0].dim.worldSphere.center.z = this->actor.world.pos.z;
...
void EnBom_Update(Actor* thisx, PlayState* play2) {
    ...
    if (thisx->params == BOMB_BODY) {
        ...
        if ((this->bombCollider.base.acFlags & AC_HIT) || ((this->bombCollider.base.ocFlags1 & OC1_HIT) && (this->bombCollider.base.oc->category == ACTORCAT_ENEMY))
            || ((this->bombCollider.base.ocFlags1 & OC1_HIT) &&((this->bombCollider.base.oc->id == 0x0203) ||(this->bombCollider.base.oc->id == ACTOR_OBJ_BOMBIWA)))) {
            this->timer = 0;
            thisx->shape.rot.z = 0;
        } else {
