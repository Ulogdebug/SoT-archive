...
static DamageTable sDamageTable = {
    ...
    /* Deku stick    */ DMG_ENTRY(0, 0xD),//0xD splash effect ,no damage
    /* Slingshot     */ DMG_ENTRY(0, 0xD),//0xF normal
    /* Explosive     */ DMG_ENTRY(4, 0xF),
    ...
    /* Master sword  */ DMG_ENTRY(1, 0xE),
    /* Giant's Knife */ DMG_ENTRY(2, 0xE),
    /* Fire arrow    */ DMG_ENTRY(3, 0xE),
    /* Ice arrow     */ DMG_ENTRY(3, 0xE),
    /* Light arrow   */ DMG_ENTRY(10, 0xE),
    ...
    /* Kokiri jump   */ DMG_ENTRY(0, 0xE),
    /* Giant jump    */ DMG_ENTRY(4, 0xE),
    /* Master jump   */ DMG_ENTRY(2, 0xE),
...
void func_80A74398(Actor* thisx, PlayState* play) {
    ...
    if (this->switchFlags != 0xFF || this->switchFlags != 0x3F) {
...
s32 func_80A745E4(EnIk* this, PlayState* play) {
    if (((this->armorDown != 0) || (this->actor.params == 0)) &&
...
void func_80A747C0(EnIk* this, PlayState* play) {
    ...
    if (this->bodyCollider.base.acFlags & AC_HIT||this->actor.xzDistToPlayer < 100.0f) {
...
void En_IkMove(EnIk* this) {
    ...
    if (this->armorDown == 0) {
        ...
        this->actor.speedXZ = 2.0f;//original was 0.9f
    } else {
        ...
        this->actor.speedXZ = 4.0f;//original was 2.5f
    }
...
void EnIk_SetupVerticalCut(EnIk* this) {
    ...
    this->axeCollider.info.toucher.damage = 0x20;
    this->unk_2FF = 1;
    this->unk_2F8 = 6;
    this->actor.speedXZ = 0.0f;
...
void EnIk_VerticalCut(EnIk* this, PlayState* play) {
    ...
    if ((this->skelAnime.curFrame > 17.0f) && (this->skelAnime.curFrame < 23.0f)) {
        ...
        if ((this->skelAnime.curFrame < 10.0f)) {
            Math_SmoothStepToS(&this->actor.world.rot.y, this->actor.yawTowardsPlayer, 1, 0x3DC, 0);
            this->actor.shape.rot.y = this->actor.world.rot.y;
        }
        this->unk_2FE = 0;
    }
...
void func_80A75C38(EnIk* this, PlayState* play) {
    ...
    if ((this->actor.params != 0) && (this->armorDown != 0)) {
        if ((prevHealth > 10) && (this->actor.colChkInfo.health <= 10)) {
...
void EnIk_PostLimbDraw3(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (limbIndex == 12) {
        ...
        Matrix_MultVec3f(&D_80A7847C[0], &this->axePos);
