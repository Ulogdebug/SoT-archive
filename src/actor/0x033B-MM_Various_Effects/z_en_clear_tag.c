...
//#include "overlays/ovl_En_Clear_Tag/ovl_En_Clear_Tag.c" Original to MM

u64 gClearTagDebrisEffectTex[] = {
#include "clear_tag_debris_effect.rgba16.inc"
};

Vtx gClearTagDebrisEffectVtx[] = {
#include "gClearTagDebrisEffectVtx.vtx.inc"
};

Gfx gClearTagDebrisEffectMaterialDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gClearTagDebrisEffectTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP,
...
Gfx gClearTagDebrisEffectDL[] = {
    gsSPVertex(gClearTagDebrisEffectVtx, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

u64 gClearTagFireEffectFlickerTex[] = {
#include "clear_tag_fire_effect_flicker.i4.inc"
};

u64 gClearTagFireEffectBackgroundTex[] = {
#include "clear_tag_fire_effect_background.i4.inc"
};

Vtx gClearTagFireEffectVtx[] = {
#include "gClearTagFireEffectVtx.vtx.inc"
};

Gfx gClearTagFireEffectMaterialDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock_4b(gClearTagFireEffectFlickerTex, G_IM_FMT_I, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                            G_TX_NOMIRROR | G_TX_WRAP, 5, 6, G_TX_NOLOD, 15),
    gsDPLoadMultiBlock_4b(gClearTagFireEffectBackgroundTex, 0x0100, 1, G_IM_FMT_I, 32, 32, 0, G_TX_NOMIRROR |
...
Gfx gClearTagFireEffectDL[] = {
    gsSPDisplayList(0x08000000),
    gsSPVertex(gClearTagFireEffectVtx, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

u64 gClearTagFlashEffectTex[] = {
#include "clear_tag_flash_effect.i8.inc"
};

Vtx gClearTagFlashEffectVtx[] = {
#include "gClearTagFlashEffectVtx.vtx.inc"
};

Gfx gClearTagFlashEffectDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gClearTagFlashEffectTex, G_IM_FMT_I, G_IM_SIZ_8b, 64, 64, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0,
                       COMBINED),
    gsDPSetRenderMode(G_RM_PASS, G_RM_ZB_CLD_SURF2),
    gsSPClearGeometryMode(G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPVertex(gClearTagFlashEffectVtx, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

u64 gClearTagFlashEffectGroundTex[] = {
#include "clear_tag_flash_ground_effect.i4.inc"
};

Vtx gClearTagFlashEffectGroundVtx[] = {
#include "gClearTagFlashEffectGroundVtx.vtx.inc"
};

Gfx gClearTagFlashEffectGroundDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock_4b(gClearTagFlashEffectGroundTex, G_IM_FMT_I, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                            G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA_PRIM, G_CC_PASS2),
    gsDPSetRenderMode(G_RM_PASS, G_RM_ZB_OVL_SURF2),
    gsSPClearGeometryMode(G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPSetGeometryMode(G_CULL_BACK),
    gsSPVertex(gClearTagFlashEffectGroundVtx, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

u64 gClearTagLightRayEffectTex[] = {
#include "clear_tag_light_ray_effect.i8.inc"
};

Vtx gClearTagLightRayEffectVtx[] = {
#include "gClearTagLightRayEffectVtx.vtx.inc"
};

Gfx gClearTagLightRayEffectMaterialDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gClearTagLightRayEffectTex, G_IM_FMT_I, G_IM_SIZ_8b, 64, 64, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0,
                       COMBINED),
    gsDPSetRenderMode(G_RM_PASS, G_RM_ZB_CLD_SURF2),
...
Gfx gClearTagLightRayEffectDL[] = {
    gsSPVertex(gClearTagLightRayEffectVtx, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
    ...
    if (thisx->params >= 0) {
        ...
        if (thisx->params != CLEAR_TAG_SPLASH) {
            ...
            for (i = 0; i < 44; i++) {
                ...
                Matrix_RotateY(Rand_ZeroFloat(2 * M_PI), MTXMODE_NEW);
    ...
    for (i = 0; i < ARRAY_COUNT(this->effect); i++, effect++) {
        if (effect->type == CLEAR_TAG_EFFECT_SPLASH) {
            ...
            for (j = 0; j < 16; j++) {
                ...
                Matrix_RotateY(2.0f * (j * M_PI) * (1.0f / 16.0f), MTXMODE_NEW);
                ...
                if (WaterBox_GetSurface1(play, &play->colCtx, effect->pos.x + vec.x, effect->pos.z + vec.z, &ySurface,
                    ...
                    if ((effect->pos.y - ySurface) < 200.0f) {
                        ...
                        Matrix_RotateY(2.0f * (j * M_PI) * (1.0f / 16.0f), MTXMODE_APPLY);
                        Matrix_RotateXFApply(effect->rotationX);
                        Matrix_Scale(effect->scale, effect->scale, effect->scale, MTXMODE_APPLY);
                        //gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(gfxCtx), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
                        gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(gfxCtx,__FILE__,__LINE__), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
