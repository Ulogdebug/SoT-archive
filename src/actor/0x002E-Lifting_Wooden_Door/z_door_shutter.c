...
const ActorInit Door_Shutter_InitVars = {
    ...
    NULL,//(ActorFunc)DoorShutter_Draw,
};
...
static ShutterObjectInfo sObjectInfo[] = {
    { OBJECT_GND, 4, 4 },
    { OBJECT_GAMEPLAY_KEEP, 8, 8 },
    { OBJECT_GAMEPLAY_KEEP, 8, 8 },//Deku Tree
    { OBJECT_HAKA_DOOR, 14, 15 },//Dodongo
    { OBJECT_GAMEPLAY_KEEP, 8, 8 },
    { OBJECT_GAMEPLAY_KEEP, 8, 8 },
    { OBJECT_BDOOR, 7, 7 },
    { OBJECT_GAMEPLAY_KEEP, 8, 8 },
    ...
    { OBJECT_GANON_OBJECTS, 11, 11 },
    { OBJECT_JYA_DOOR, 6, 6 },
    { OBJECT_GAMEPLAY_KEEP, 8, 8 }, //water temple
    { OBJECT_HAKA_DOOR, 14, 15 },
    { OBJECT_GAMEPLAY_KEEP, 8, 8 },
    { OBJECT_GAMEPLAY_KEEP, 8, 8 },
    { OBJECT_GAMEPLAY_KEEP, 8, 8 },
...
static BossDoorInfo D_80998288[] = {
    { SCENE_HIDAN, SCENE_FIRE_BS, 0x01 },//0x01
