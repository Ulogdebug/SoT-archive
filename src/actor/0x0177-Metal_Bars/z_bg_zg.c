...
#include <uLib.h>
#include "z_bg_zg.h"
#include "object/0x0156-Ganons_Tower_Door_Bars.h"
...
void BgZg_Init(Actor* thisx, PlayState* play) {
    ...
    colHeader = NULL;
    CollisionHeader_GetVirtual(&gMetalBarObj_CollMetalBarObj, &colHeader);
...
void func_808C0EEC(BgZg* this, PlayState* play) {
    ...
    gSPDisplayList(POLY_OPA_DISP++, gMetalBarObj_DlMetalBarObj);
