...
static DamageTable sDamageTable = {
    ...
    /* Deku stick    */ DMG_ENTRY(4, 0x0),
    /* Slingshot     */ DMG_ENTRY(1, 0x0),
    /* Explosive     */ DMG_ENTRY(4, 0x0),
    ...
    /* Unk arrow 2   */ DMG_ENTRY(4, 0x0),
    /* Unk arrow 3   */ DMG_ENTRY(4, 0x0),
...
void EnPoh_Init(Actor* thisx, PlayState* play) {
    ...
    this->unk_194 = 0;
    this->unk_195 = 32;
    this->switchFlags = (this->actor.params >> 8) & 0xFF; //Variables Form : **00
    ...
    Lights_PointGlowSetInfo(&this->lightInfo, this->actor.home.pos.x, this->actor.home.pos.y, this->actor.home.pos.z,
                            255, 255, 255, 0);
    if(Flags_GetSwitch(play, this->switchFlags) && (this->switchFlags != 0x0)){
...
void func_80ADEAC4(EnPoh* this, PlayState* play) {
    ...
    if (this->actor.xzDistToPlayer < 200.0f && this->actor.yDistToPlayer < 80.0f) {
        func_80ADE1BC(this);
...
void func_80ADEC9C(EnPoh* this, PlayState* play) {
    ...
    EnPoh_MoveTowardsPlayerHeight(this, play);
    if (this->actor.xzDistToPlayer >= 400.0f && this->actor.yDistToPlayer >= 80.0f) {
        EnPoh_SetupIdle(this);
...
void func_80ADEF38(EnPoh* this, PlayState* play) {
    ...
    if (this->skelAnime.playSpeed < 0.5f && this->actor.xzDistToPlayer < 280.0f && this->actor.yDistToPlayer < 80.0f) {
        Audio_PlayActorSfx2(&this->actor, NA_SE_EN_PO_APPEAR);
...
void func_80ADF15C(EnPoh* this, PlayState* play) {
    ...
    if (this->unk_198 < 8) {
        ...
        if (this->unk_198 == 1) {
            ...
            Message_StartTextbox(play, 0X01AC, NULL);
...
void func_80ADF894(EnPoh* this, PlayState* play) {
    ...
    EnPoh_MoveTowardsPlayerHeight(this, play);
    if (this->unk_198 == 0 || this->actor.xzDistToPlayer > 250.0f && this->actor.yDistToPlayer >= 80.0f) {
        this->actor.world.rot.y = this->actor.shape.rot.y;
        EnPoh_SetupIdle(this);
    }
...
void EnPoh_UpdateLiving(Actor* thisx, PlayState* play) {
    ...
    Vec3f checkPos;
    s32 bgId;
    func_8002F5F0(&this->actor, play); //Rumbling
