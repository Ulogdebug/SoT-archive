...
#define SWITCH_FLAG(this) ((this->dyna.actor.params >> 8) & 0xFF)
#define DURATION(this) (this->dyna.actor.params & 0x3F)
...
void WallPullSwitch_Init(Actor* thisx, PlayState* play) {
    ...
    if (Flags_GetSwitch(play, SWITCH_FLAG(this)) && (SWITCH_FLAG(this) != 0X0 ) && (SWITCH_FLAG(this)!=0X3F)) {
...
void WallPullSwitch_Retract(WallPullSwitch* this, PlayState* play) {
    DECR(this->timer);
    //play timing sfx
    if((SWITCH_FLAG(this) != 0X0 ) && (SWITCH_FLAG(this)!=0X3F)){
...
void WallPullSwitch_SetupRetract(WallPullSwitch* this, PlayState* play) {
    ...
    if (duration == 0) {
        if((SWITCH_FLAG(this)!=0x3F) && (SWITCH_FLAG(this)!= 0X0)){        
