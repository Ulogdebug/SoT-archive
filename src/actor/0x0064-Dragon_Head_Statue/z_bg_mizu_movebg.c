...
void BgMizuMovebg_Pasue(BgMizuMovebg* this, PlayState* play);
void BgMizuMovebg_TorchPosUpdate(BgMizuMovebg* this, PlayState* play);
void BgMizuMovebg_SwitchPosUpdate(BgMizuMovebg* this, PlayState* play);
...
void func_8089E650(BgMizuMovebg* this, PlayState* play) {
    ...
    // if(Flags_GetSwitch(play, this->switchFlags)){
    //     this->actionFunc = BgMizuMovebg_Pasue;
    // }
}
...
void BgMizuMovebg_Update(Actor* thisx, PlayState* play) {
    ...
    if(MOVEBG_TYPE(thisx->params) == 7){
        ...
        if(this->torchIsOnTop){
            BgMizuMovebg_TorchPosUpdate(this,play);
        }
        if(this->switchIsOnTop){
            BgMizuMovebg_SwitchPosUpdate(this,play);
        }
    }
