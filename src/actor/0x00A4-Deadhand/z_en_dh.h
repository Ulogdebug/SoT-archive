...
typedef struct EnDh {
    /* 0x0000 */ Actor actor;
                 Actor* attachedActor[2];//CUSTOM PARA
    ...
    /* 0x0259 */ u8 unused_259;
                 u8 ArmspawnCounter;//CUSTOM PARA
                 u8 BackarmsCounter; //CUSTOM PARA
    /* 0x025A */ u8 alpha;               
    /* 0x025B */ u8 curAction;
                 u8 dirtShieldFlag;//CUSTOM PARA
                 u8 BurrowFlag;//CUSTOM PARA
    /* 0x025C */ s16 timer;
    /* 0x025E */ s16 dirtWavePhase;
                 s16 dirtShieldTimer; //CUSTOM PARA
