...
void EnSkb_WalkForward(EnSkb* this, PlayState* play) {
    ...
    if (Math_Vec3f_DistXZ(&this->actor.home.pos, &player->actor.world.pos) > 500.0f || this->findPlayerTimer <= 0 || ABS(this->actor.yDistToPlayer) > 80.0F ) {
