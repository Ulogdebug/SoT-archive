    ...
    switch (type) {
        ...
        default:
            ...
            if ((type > 0) && (type < 3)) {
                ...
                this->alpha = 255;
                if(Flags_GetSwitch(play,this->switchFlags) && this->switchFlags != 0xFF && this->switchFlags != 0x0){
...
void EnSkj_SariasSongKidIdle(EnSkj* this, PlayState* play) {
    if (this->actor.params == 0) {
        ...
        if ((func_80AFEDF8(this, play) != 0) && ABS(this->actor.yDistToPlayer) < 60.0f) {
            this->isNeedleType = 1;
            func_80AFF334(this);
        }
    }
...
void EnSkj_WaitForDeathAnim(EnSkj* this, PlayState* play) {
    ...
    if (this->skelAnime.curFrame == lastFrame) {
        if(this->switchFlags != 0xFF && this->switchFlags != 0x0){
...
void EnSkj_Fight(EnSkj* this, PlayState* play) {
    ...
    if (this->needleShootTimer == 0 && ABS(this->actor.yDistToPlayer) < 60.0f) {
