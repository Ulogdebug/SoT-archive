...
void MirRay_Init(Actor* thisx, PlayState* play) {
    ...
    this->sourcePt.x = this->actor.home.pos.x;
    this->sourcePt.y = this->actor.home.pos.y;
    this->sourcePt.z = this->actor.home.pos.z;

    this->sourceEndRad = dataEntry->sourceEndRadius;

    this->poolPt.x  = player->actor.pos.x;
    this->poolPt.y  = player->actor.pos.y;
    this->poolPt.z  = player->actor.pos.z;
