...
void KaleidoScope_DrawAmmoCount(PauseContext* pauseCtx, GraphicsContext* gfxCtx, s16 item) {
    ...
    if (!((gSlotAgeReqs[SLOT(item)] == 9) || ((gSlotAgeReqs[SLOT(item)] == ((void)0,gSaveContext.linkAge)) && !ghackSave.disArmed))) {
...
void KaleidoScope_DrawItemSelect(PlayState* play) {
    ...
    if ((pauseCtx->state == 6) && (pauseCtx->unk_1E4 == 0) && (pauseCtx->pageIndex == PAUSE_ITEM)) {
        ...
        if (pauseCtx->cursorSpecialPos == 0) {
            ...
            if (!((gSlotAgeReqs[cursorSlot] == 9) || ((gSlotAgeReqs[cursorSlot] == ((void)0,gSaveContext.linkAge))&& !ghackSave.disArmed ))) {
                ...
                if ((pauseCtx->debugState == 0) && (pauseCtx->state == 6) && (pauseCtx->unk_1E4 == 0)) {
                    if (CHECK_BTN_ANY(input->press.button,BTN_CLEFT | BTN_CDOWN | BTN_CRIGHT)) {
                        if (
                            ...
                            ((gSlotAgeReqs[cursorSlot] == ((void)0,gSaveContext.linkAge)&& !ghackSave.disArmed))) &&
    ...
    for (i = j = 0; i < 24; i++,j += 4) {
        ...
        if (gSaveContext.inventory.items[i] != ITEM_NONE) {
            if ((pauseCtx->unk_1E4 == 0) && (pauseCtx->pageIndex == PAUSE_ITEM) && (pauseCtx->cursorSpecialPos == 0)) {
                if ((gSlotAgeReqs[i] == 9) || ((gSlotAgeReqs[i] == ((void)0,gSaveContext.linkAge)) && !ghackSave.disArmed)) {
