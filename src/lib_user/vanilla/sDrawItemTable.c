...
DrawItemTableEntry hackDrawItemTable[] = { //127 entry
    ...
    { GetItem_DrawOpa0, { (void *)0x060016E8/*gGiDekuShieldDL*/ } },
    ...
    { GetItem_DrawOpa0, { (void *)0x06000F38/*gGiHylianShieldDL*/  } },
    //{ GetItem_DrawOpa0, { (void *)0x06001D20,(void *)0x060014C8,(void *)0x06001410,(void *)0x06001358 } },
    // hookshot, OBJECT_GI_HOOKSHOT
    { GetItem_DrawOpa0, { (void *)0x060018B0 } },
    ...
    { /*GetItem_DrawOpa0,  { (void *)0x06001680 }*/GetItem_DrawOpa0Xlu1, { gGiLensDL, gGiLensGlassDL } },
    ...
    { GetItem_DrawOpa0, { (void *)0x060014C8} },
    ...
    { GetItem_DrawOpa0Xlu1, { (void *)0x06000A18, (void *)0x06000370,(void *)0x060002BB } },
...
void GetItem_DrawMaskOrBombchu(PlayState* play, s16 drawId) {
    ...
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[0]);

    CLOSE_DISPS(play->state.gfxCtx, "../z_draw.c", 565);
}

Asm_VanillaHook(GetItem_DrawSoldOut);
void GetItem_DrawSoldOut(PlayState* play, s16 drawId) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, hackDrawItemTable[drawId].dlists[0]);

    CLOSE_DISPS(play->state.gfxCtx, "../z_draw.c", 581);
}

Asm_VanillaHook(GetItem_DrawBlueFire);
void GetItem_DrawBlueFire(PlayState* play, s16 drawId) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, hackDrawItemTable[drawId].dlists[1]);
    Matrix_Pop();
...
Asm_VanillaHook(GetItem_DrawPoes);
void GetItem_DrawPoes(PlayState* play, s16 drawId) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, hackDrawItemTable[drawId].dlists[3]);
    gSPDisplayList(POLY_XLU_DISP++, hackDrawItemTable[drawId].dlists[2]);
    Matrix_Pop();
...
Asm_VanillaHook(GetItem_DrawFairy);
...
Asm_VanillaHook(GetItem_DrawMirrorShield);
...
Asm_VanillaHook(GetItem_DrawSkullToken);
...
Asm_VanillaHook(GetItem_DrawEggOrMedallion);
void GetItem_DrawEggOrMedallion(PlayState* play, s16 drawId) {
    ...
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[0]);
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[1]);

    CLOSE_DISPS(play->state.gfxCtx, "../z_draw.c", 783);
}

Asm_VanillaHook(GetItem_DrawCompass);
...
Asm_VanillaHook(GetItem_DrawPotion);
void GetItem_DrawPotion(PlayState* play, s16 drawId) {
    ...
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[1]);
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[0]);
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[2]);
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[3]);

    Gfx_SetupDL_25Xlu(play->state.gfxCtx);
    gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(play->state.gfxCtx, "../z_draw.c", 855), G_MTX_MODELVIEW | G_MTX_LOAD);
    gSPDisplayList(POLY_XLU_DISP++, hackDrawItemTable[drawId].dlists[4]);
    gSPDisplayList(POLY_XLU_DISP++, hackDrawItemTable[drawId].dlists[5]);

    CLOSE_DISPS(play->state.gfxCtx, "../z_draw.c", 861);
}


Asm_VanillaHook(GetItem_DrawGoronSword);
...
Asm_VanillaHook(GetItem_DrawDekuNuts);
...
Asm_VanillaHook(GetItem_DrawRecoveryHeart);
...
Asm_VanillaHook(GetItem_DrawFish);
...
Asm_VanillaHook(GetItem_DrawOpa0);
...
Asm_VanillaHook(GetItem_DrawOpa0Xlu1);
...
Asm_VanillaHook(GetItem_DrawXlu01);
...
Asm_VanillaHook(GetItem_DrawOpa10Xlu2);
...
Asm_VanillaHook(GetItem_DrawOpa1023);
...
Asm_VanillaHook(GetItem_DrawOpa10Xlu32);
...
Asm_VanillaHook(GetItem_DrawSmallRupee);
...
Asm_VanillaHook(GetItem_DrawScale);
...
Asm_VanillaHook(GetItem_DrawBulletBag);
...
Asm_VanillaHook(GetItem_DrawWallet);
void GetItem_DrawWallet(PlayState* play, s16 drawId) {
    ...
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[2]);
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[3]);
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[4]);
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[5]);
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[6]);
    gSPDisplayList(POLY_OPA_DISP++, hackDrawItemTable[drawId].dlists[7]);
