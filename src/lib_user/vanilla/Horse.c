...
Asm_VanillaHook(func_8006CFC0);
s32 func_8006CFC0(s32 sceneId) {
    // s32 validSceneIds[] = { 0x2A,0x6C,0x3F,0x0B,0X6B };
    // s32 i;
...
Asm_VanillaHook(func_8006D0EC);
void func_8006D0EC(PlayState* play, Player* player) {
    s32 i;
    HorseSpawn horseSpawns[] = { // it also decides if you could call Epona with Epona song
        { 0x3F, -1780, 34, -437, 0, 2 }, /* Mushroom Swamp */ 
        { 0x57, -1321, -255, 1090, 0, 2 }, /* Wasteland */
        { 0x6B, 2148, -259, -528, 0, 2 }, /*Border Desert*/
        { 0x5A, 2500, -59, -6633, 0, 2 },/*Border Fortress*/
        { 0x2A, 407, 79, 386, 0, 2 },/*Town-Field*/
        { 0x3A, 106,-75, -25, 0, 2 },/*Desert Valley*/
        { 0x5D, 2849,1390, -433, 0, 2 },/*Horseback Archery */
    };
